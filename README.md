...
1. Fill all ratings of 0 with np.nan.
   ...
   - Rating is on a scale from 1 to 5. Hence, a rating of 0 indicates missing values in rating. Thus, to avoid bias in the ratings, we filled the value 0 with np.nan.
